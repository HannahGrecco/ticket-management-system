<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">Novo chamado</h2>
    </x-slot>
            ...
            <div class="overflow-hidden rounded-lg bg-white p-6 shadow-sm">
                <form method="POST" action="{{ route('tickets.store') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input id="title" name="title" type="text" value="{{ old('title') }}" class="w-full rounded-md border border-gray-300 px-3 py-2" required>
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        <button type="submit" class="rounded-md bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white hover:bg-slate-700">Salvar</button>
